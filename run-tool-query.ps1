# Run Tool Table Query
# This script queries the database for tool table structures

$ErrorActionPreference = "Stop"

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "  Tool Table Structure Query" -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan
...
$outputFile = "tool-tables-output.txt"
sqlplus -S $connStr "@query-tool-tables.sql" | Out-File $outputFile -Encoding UTF8
